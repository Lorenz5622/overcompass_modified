...
declare -a MODEL_DATASET_PAIRS=(
  ...
  # "/mnt/data/models/Predict_MoE_arc_c_s42/|predict_moe|arc_c_ppl"
  # "/mnt/data/models/Predict_MoE_arc_c_s43/|predict_moe|arc_c_ppl"
  # "/mnt/data/models/Predict_MoE_arc_c_s44/|predict_moe|arc_c_ppl"
  "/mnt/data/models/Predict_MoE_arc_e_s42/|predict_moe|arc_e_ppl"
  "/mnt/data/models/Predict_MoE_arc_e_s43/|predict_moe|arc_e_ppl"
  "/mnt/data/models/Predict_MoE_arc_e_s44/|predict_moe|arc_e_ppl"
  # "/mnt/data/models/Predict_MoE_oqa_s42/|predict_moe|obqa_ppl"
  # "/mnt/data/models/Predict_MoE_oqa_s43/|predict_moe|obqa_ppl"
  # "/mnt/data/models/Predict_MoE_oqa_s44/|predict_moe|obqa_ppl"
  # "/mnt/data/models/Predict_MoE_piqa_s42/|predict_moe|piqa_ppl"
  # "/mnt/data/models/Predict_MoE_piqa_s43/|predict_moe|piqa_ppl"
  # "/mnt/data/models/Predict_MoE_piqa_s44/|predict_moe|piqa_ppl"
  # "/mnt/data/models/Predict_MoE_siqa_s42/|predict_moe|siqa_ppl"
  # "/mnt/data/models/Predict_MoE_siqa_s43/|predict_moe|siqa_ppl"
  # "/mnt/data/models/Predict_MoE_siqa_s44/|predict_moe|siqa_ppl"
  # "/mnt/data/models/Predict_MoE_winogrande_s42/|predict_moe|winograd_ppl"
  # "/mnt/data/models/Predict_MoE_winogrande_s43/|predict_moe|winograd_ppl"
  # "/mnt/data/models/Predict_MoE_winogrande_s44/|predict_moe|winograd_ppl"
